...
import { type Student, StudentDefault } from "@/app/students/types";

import { saveItem, updateItem } from "@/app/students/services";
...
const props = defineProps({
  formState: {
    type: Object as () => Partial<Student>,
    default: () => ({}),
  },
});

const form: Ref<Student> = ref({
  ...StudentDefault,
  ...props.formState,
});
